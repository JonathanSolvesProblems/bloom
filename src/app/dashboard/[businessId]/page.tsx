              ...
              {subscriberCount > 0 ? (
                <>
                  ...
                  <div className="space-y-1">
                    ...
                    {subscriberCount > 5 && (
                      <p className="text-xs text-muted">+{subscriberCount - 5} more</p>
                    )}
                  </div>
                </>
              ) : (
                <div>
                  <p className="text-sm text-muted mb-3">No subscribers yet. Share your signup link with customers.</p>
                  <div className="bg-surface rounded-lg px-3 py-2 text-xs text-muted font-mono break-all">
