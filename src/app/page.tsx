...
const steps = [
  ...
  },
  {
    ...
    desc: 'Three social posts and a full email newsletter, in your brand voice, generated by Gemini in under a minute.',
  },
  {
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 pt-16 pb-20 lg:pt-24 lg:pb-28 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-sm text-muted mt-4">
                No card to preview. Your free sample is ready in under a minute.
              </p>
            </div>
